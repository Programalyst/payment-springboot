...
public class KafkaProducerConfig {
    ...
    // TransactionResponse is a rich Java Record structure residing in memory.
    ...
    @Bean
    public KafkaTemplate<String, TransactionResponse> kafkaTemplate() { // <> operator infers type from here
        // <> diamond operator infers type of producerFactory() <String, TransactionResponse>
